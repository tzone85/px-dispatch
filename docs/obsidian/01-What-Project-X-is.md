---
title: What Project X is
tags: [project-x, overview]
---

# What Project X is

Project X (binary: `px`) is an autonomous coding team you can hand a
...
time, with one context window. Project X parallelises that work the way a
